...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { birth_date: @dog.birth_date, breed_id: @dog.breed_id, in_daycare: @dog.in_daycare, name: @dog.name, owner_id: @dog.owner_id, vet_id: @dog.vet_id }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { birth_date: @dog.birth_date, breed_id: @dog.breed_id, in_daycare: @dog.in_daycare, name: @dog.name, owner_id: @dog.owner_id, vet_id: @dog.vet_id }
    assert_redirected_to dog_path(assigns(:dog))
  end
